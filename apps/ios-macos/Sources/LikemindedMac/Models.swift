...
struct MacNotificationItem: Decodable, Identifiable, Equatable {
    let id: String
    let title: String
    let detail: String?
    let createdAt: String?
...
struct MacNotificationsResponse: Decodable {
    let notifications: [MacNotificationItem]
    let activity: [MacNotificationItem]
}
